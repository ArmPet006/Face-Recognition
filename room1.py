...
while True:
    ...
    for (x, y, w, h) in face_rects:
        ...
        # Draw rectangle
        rectangle_color = (0, 0, 255) if matched_names and "room1" in [access.lower() for access in known_face_access[np.argmin(distances)]] else (
            0, 255, 0)  # Green if recognized and has access, red otherwise
